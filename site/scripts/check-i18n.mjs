...
const LATIN_OK =
  /Google Play|App Store|Apple|Google Gemini|Google|Gemini|HTTPS|IP|\{operator\}|WD-40|\{version\}|\{size\}|\{date\}|Android|Cookie|cookie|km\/h|Pro-Stuk|Stuk|APK|LPG|ABS|TSI|GDI|CVT|MIN|MAX|MT|AT|MB|km|[DRV](?![A-Za-z])/g;
const A = 'A-Za-z';
const SCRIPTS = {
