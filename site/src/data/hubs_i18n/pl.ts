...
export const pl: Record<string, HubText> = {
  dvigatel: {
    ...
    short: 'Silnik',
    metaTitle: 'Hałasy i stukanie silnika: przewodnik | Stuk',
    description:
  ...
  podveska: {
    ...
    metaTitle: 'Stuki i skrzypienie zawieszenia: przewodnik | Stuk',
    description:
      'Stuk na nierównościach, skrzypienie, luz na kierownicy: jak ustalić źródło w zawieszeniu i układzie kierowniczym i co sprawdzisz sam.',
    intro: [
  ...
  tormoza: {
    ...
    metaTitle: 'Piski i zgrzyt hamulców: przewodnik | Stuk',
    description:
  ...
  transmissiya: {
    ...
    short: 'Napęd',
    metaTitle: 'Hałasy skrzyni i napędu: przewodnik | Stuk',
    description:
  ...
  vyhlop: {
    ...
    short: 'Wydech',
    metaTitle: 'Hałasy wydechu: pełny przewodnik | Stuk',
    description:
  ...
  salon: {
    ...
    metaTitle: 'Skrzypienie we wnętrzu: jak znaleźć źródło | Stuk',
    description:
